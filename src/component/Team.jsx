...
const Team = () => {
    ...
    const smootherRef = useRef(null);
    const gsapContext = useRef(null);
    const floatingSymbolsRef = useRef(null);
    ...
    useEffect(() => {
        ...
        gsapContext.current = gsap.context(() => {
            ...
            // Enhanced Hover Overlay Animations for Team Boxes with Glow Effect
        ...
        <>
            ...
            <div>
                <div id="smooth-content">
                    ...
                    <section id="quanto-team-area" className="vastu-team-section section-padding-top-bottom">
                        {/* Floating Mandala Background */}
                        <svg className="mandala-bg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="100" cy="100" r="80" fill="none" stroke="#921352ff" strokeWidth="1.5"/>
                            <circle cx="100" cy="100" r="60" fill="none" stroke="#921352ff" strokeWidth="1.2"/>
                            <circle cx="100" cy="100" r="40" fill="none" stroke="#921352ff" strokeWidth="1.0"/>
                            <circle cx="100" cy="100" r="20" fill="none" stroke="#921352ff" strokeWidth="0.5"/>
                            {[...Array(12)].map((_, i) => (
                                <line 
                                    key={i}
                                    x1="100" 
                        ...
                        {/* Floating Symbols */}
                        <div className="floating-symbols" ref={floatingSymbolsRef}>
                            ...
                            <div className="floating-symbol" style={{top: '85%', left: '45%'}}>📿</div>
                        </div>

                        <div className="container custom-container position-relative" style={{zIndex: 2}}>
                            <div className="vastu-logo-watermark">VS</div>
                            
                            <div className="row gx-4 gy-2 align-items-end mb-5">
                                <div className="col-md-9 col-xl-7 col-xxl-6">
                                    <div className="quanto__header">
                                        <h3 className="vastu-header-title text-center text-md-start fade-anim word-anim" data-delay="0.30" data-direction="left">
                            ...
                            <div className="row gx-4 gy-5 gx-sm-3 gx-md-4 row-padding-top">
                                {[
                                    ...
                                    { name: "Guruji Ramesh Patel", position: "Commercial Vastu Advisor", img: "/assets/images/team/team-5.png", link: "/team-details" },
                                    { name: "Kavita Desai", position: "Interior Vastu Designer", img: "/assets/images/team/team-6.png", link: "/team-details" },
                                    { name: "Shastri Amit Joshi", position: "Spiritual Vastu Guide", img: "/assets/images/team/team-7.png", link: "/team-details" },
                                    { name: "Swami Anand", position: "Traditional Vastu Master", img: "/assets/images/team/team-8.png", link: "/team-details" },
                                ].map((member, index) => (
                                    <div key={index} className="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                            ...
                                            <div className="swiper-slide">
                                                <div className="testimonial3-content">
                                                    <p className="move-anim" data-delay="0.45">
                                                        The Vastu consultation transformed our home's energy completely. Our family feels more harmonious and prosperous. Highly recommended for anyone seeking positive changes!
                                                    </p>
                                                    <div className="client-info">
                                                        <h5 className="client-name word-anim" data-delay="0.60">Rahul Verma</h5>
                                                        <span className="client-designation move-anim" data-delay="0.75">Homeowner, Mumbai</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
