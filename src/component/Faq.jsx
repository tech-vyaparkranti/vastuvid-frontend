...
const Faq = () => {
    ...
    useEffect(() => {
        ...
        gsapContext.current = gsap.context(() => {
            ...
            // Odometer Counter (optional, if you want to add counters to the FAQ page)
            ...
            // Swiper Sliders (optional, if you want to add a slider to the FAQ page)
            ...
            // Move Animation for FAQ Content
            ...
            // Fade Animation for FAQ Items and Hero Thumbnail
            ...
            // Word Animation for Titles and Accordion Questions
                ...
                <div id="smooth-content">
                        ...
                        <div className="container custom-container">
                            <div className="row g-4">
                                <div className="col-lg-12 col-xxl-11">
                                    <div className="quanto-hero-faq__content move-anim" data-delay="0.45">
                                        <h1 className="title word-anim" data-delay="0.60">Quick answers to common questions</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="quanto-video-area style-2 overflow-hidden">
                        <div className="container custom-container position-relative">
                            <Link to="#quanto-faq-area" className="scroll-down section-link">
                                Scroll down
